...
from jy901_angulo import angulo
...
def callback(msg):
    ...
    if len(time_list) == TAMANHO:

        all_lists = [temp_list, roll_list, pitch_list, yaw_list, ang_x_list, ang_y_list,
                     ang_z_list, time_list, ang_ester_list]
        ...
        data = {
            "ang_estercamento": ang_ester_list,
        ...
        df.to_csv("dados_excel2.csv", index=False)
        print(df)
        sleep(30)
